...
0
|| checktplrefresh('./template/yeei_xiami/forum/discuz.htm', './template/yeei_xiami/common/header.htm', 1354357627, 'diy', './data/template/3_diy_forum_discuz.tpl.php', './template/yeei_xiami', 'forum/discuz')
|| checktplrefresh('./template/yeei_xiami/forum/discuz.htm', './template/yeei_xiami/common/footer.htm', 1354357627, 'diy', './data/template/3_diy_forum_discuz.tpl.php', './template/yeei_xiami', 'forum/discuz')
|| checktplrefresh('./template/yeei_xiami/forum/discuz.htm', './template/default/common/header_common.htm', 1354357627, 'diy', './data/template/3_diy_forum_discuz.tpl.php', './template/yeei_xiami', 'forum/discuz')
|| checktplrefresh('./template/yeei_xiami/forum/discuz.htm', './template/yeei_xiami/common/pubsearchform.htm', 1354357627, 'diy', './data/template/3_diy_forum_discuz.tpl.php', './template/yeei_xiami', 'forum/discuz')
;?>
...
<?php } ?>
                             <?php if($_G['setting']['taskon'] && !empty($_G['cookie']['taskdoing_'.$_G['uid']])) { ?><span class="pipe">|</span><a href="home.php?mod=task&amp;item=doing" id="task_ntc" class="new">任务</a><?php } if(($_G['group']['allowmanagearticle'] || $_G['group']['allowpostarticle'] || $_G['group']['allowdiy'] || getstatus($_G['member']['allowadmincp'], 4) || getstatus($_G['member']['allowadmincp'], 2) || getstatus($_G['member']['allowadmincp'], 3))) { ?>
