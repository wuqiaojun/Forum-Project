...
0
|| checktplrefresh('./template/yeei_xiami/common/header.htm', './template/default/common/header_common.htm', 1354357672, '3', './data/template/3_3_common_header_home_spacecp.tpl.php', './template/yeei_xiami', 'common/header_home_spacecp')
|| checktplrefresh('./template/yeei_xiami/common/header.htm', './template/yeei_xiami/common/pubsearchform.htm', 1354357672, '3', './data/template/3_3_common_header_home_spacecp.tpl.php', './template/yeei_xiami', 'common/header_home_spacecp')
;?>
