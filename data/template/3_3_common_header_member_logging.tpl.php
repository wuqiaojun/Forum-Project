...
0
|| checktplrefresh('./template/yeei_xiami/common/header.htm', './template/default/common/header_common.htm', 1354359130, '3', './data/template/3_3_common_header_member_logging.tpl.php', './template/yeei_xiami', 'common/header_member_logging')
|| checktplrefresh('./template/yeei_xiami/common/header.htm', './template/yeei_xiami/common/pubsearchform.htm', 1354359130, '3', './data/template/3_3_common_header_member_logging.tpl.php', './template/yeei_xiami', 'common/header_member_logging')
;?>
